...
$sqlCategory = 'SELECT type FROM category_films WHERE id = :category_id';
...
$categoryName = GENRE_MAPPING[$category->type] ?? 'фильмы';
?>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    async function fetchFilms(page = 1) {
        const url = `https://api.kinopoisk.dev/v1.4/movie?page=${page}&limit=30&genres.name=<?= urlencode($categoryName) ?>&sortField=rating.kp&sortType=-1`;
